...
export function ThreadIdTooltip({ threadId }: { threadId: string }) {
  ...
  return (
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger>
          <p className="font-mono tracking-tighter text-[10px] leading-[12px] px-1 py-[2px] bg-secondary rounded-md">
...
export function ThreadIdCopyable({
  ...
  return (
    <TooltipIconButton
      ...
      className="flex flex-grow-0 gap-1 items-center p-1 rounded-md border-[1px] cursor-pointer hover:bg-secondary/90 border-border w-fit"
    >
